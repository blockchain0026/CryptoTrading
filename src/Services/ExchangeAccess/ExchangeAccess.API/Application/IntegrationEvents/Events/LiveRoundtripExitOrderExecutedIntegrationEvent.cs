...
{
    public class LiveRoundtripExitOrderExecutedIntegrationEvent:IntegrationEvent
    {
        public LiveRoundtripExitOrderExecutedIntegrationEvent(string investmentId, string roundtripId, int exchangeId, string orderId, string baseCurrency, string quoteCurrency, decimal executedAmount, decimal executedPrice, decimal fee)
        {
