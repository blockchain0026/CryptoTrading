...
{
    public class BacktestingTraceStartedIntegrationEvent : IntegrationEvent
    {
        public BacktestingTraceStartedIntegrationEvent(string traceId, string investmentId, int exchangeId, string baseCurrency, string quoteCurrency, DateTime from, DateTime to, IDictionary<string, int> minAmountOfCandles)
        {
            TraceId = traceId;
